...
% Input is the standard point and triangle matrix p and t. Output neighbors is a
% nt * 3 matrix, with nt the number of triangles, in which row i contains the three
% element neighbours to element i . No neighbour is indicated by -1. Each row is
% ordered in the sense that the first neighbour shares edge 1 with the element, the
% second neighbour shares edge 2, and so on.
